...
//        }
        ...
        startRecording.setOnClickListener(startRecordingClickListener);

        stopRecording = findViewById(R.id.stop_recording);
        stopRecording.setOnClickListener(stopRecordingClickListener);
        stopRecording.hide();
...
//        changeMap.setOnClickListener(changeMapTypeClickListener);
    ...
    private View.OnClickListener startRecordingClickListener = new View.OnClickListener() {
        @Override
    ...
    private View.OnClickListener stopRecordingClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            if (mSimulation) {
